...
# Repository root (this file: …/part_1_portfolio_creation/tree_portfolio_creation/step3_combine_trees.py)
    ...
    if not rf_file.is_file():
        if _SHIPPED_RF.is_file():
            ...
            raise FileNotFoundError(
                ...
                f"Place a one-column monthly risk-free rate file (% units) there, "
                f"or add {_SHIPPED_RF} (paper bundle)."
            )
