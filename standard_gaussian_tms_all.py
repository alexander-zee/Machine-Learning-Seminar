...
PROGRESS_PATH = GRID_SEARCH_PATH / KERNEL_NAME / 'progress_standard_gaussian_tms.csv'
SUMMARY_PATH  = GRID_SEARCH_PATH / KERNEL_NAME / 'all_cross_sections_summary_standard_gaussian_tms.csv'
