"""
rp_pruning.py — RP-Pruning entry point for one triplet (LME, feat1, feat2).
...
def RP_Pruning(feat1, feat2, input_path, input_file_name, output_path,
